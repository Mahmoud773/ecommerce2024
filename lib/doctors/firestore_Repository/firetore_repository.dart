...
class DoctorsFirestoreRpository {

  var usersCollection =FirebaseFirestore.instance.collection("doctors");
...
static Future<DoctorModel> getDoctorAppoints(String uid) async {
  ...
  try {
      final result= await FirebaseFirestore.instance.collection("doctors").doc("uid");
...
// get certain doctor appoints as Stream
 ...
 static Future<bool> markAsFavorite(String uid) async{
    ...
    var doctorModel =await FirebaseFirestore.instance.collection("doctors").doc(uid).get();
   ...
   try{await FirebaseFirestore.instance.collection("doctors").doc(uid).update
