...
class FMSettingsView extends StatefulWidget {
  SharedPreferences? sharedPreferences;
  FMSettingsView({Key? key , this.sharedPreferences}) : super(key: key);

  @override
  State<FMSettingsView> createState() => _FMSettingsViewState();
}

class _FMSettingsViewState extends State<FMSettingsView> {
  bool isDoctor=false;
