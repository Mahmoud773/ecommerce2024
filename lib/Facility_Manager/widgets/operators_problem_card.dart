...
class ProblemCardForOperators extends StatefulWidget {
  bool isAdmin;
  String pendingOrSolved;
  Function() onPress;
  final ProblemModel problemModel;
  bool isOperator;
  ProblemCardForOperators({super.key,required this.pendingOrSolved , required this.problemModel ,
    required this.onPress , required this.isOperator , this.isAdmin=false});

  @override
  State<ProblemCardForOperators> createState() => _ProblemCardForOperatorsState();
}

class _ProblemCardForOperatorsState extends State<ProblemCardForOperators> {
  String orderStatus="";
        ...
        child: Column(
          children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("problem type: ${widget.problemModel.problemType}",
                            style: TextStyle(
                                color: Colors.deepPurple, fontWeight: FontWeight.bold, fontSize: 13
                            ),),
                          ...
                          if(widget.problemModel.solvingDate.length>0
                              &&(widget.problemModel.isMaintenanceRespondedtoNeedPricing==true
                                  &&widget.problemModel.IsNeedRepricing==false &&
                                  nowToString==widget.problemModel.solvingDate
                              )
                          ) Row(
                            children: [
                              Icon(Icons.notifications_active_sharp , color: Colors.yellowAccent,),
                              Text("solve date is today",
                                style: TextStyle(
                                  color: Colors.yellowAccent, fontWeight: FontWeight.bold,
                                  fontSize: 13,
                                ),),
                       ...
                       if(widget.problemModel.datePricing.length>3
                           &&   nowToString!=widget.problemModel.datePricing &&
                           (widget.problemModel.isMaintenanceRespondedtoNeedPricing==true
               ...
               (widget.problemModel.isMaintenanceRespondedtoNeedPricing==true
                   &&widget.problemModel.IsNeedRepricing==true)
                            ...
                            Row(
                              children: [
                                Icon(Icons.notifications_active_sharp , color: Colors.yellowAccent,),
                                Text("date pricing: ${widget.problemModel.datePricing}",
                                  style: TextStyle(
                                    color: Colors.yellowAccent, fontWeight: FontWeight.bold,
                                    fontSize: 13,
                                  ),),
            ...
            if(widget.problemModel.solvingDate.length<3 &&widget.problemModel.isPaid==false
                ...
                ((widget.problemModel.isMaintenanceRespondedtoNeedPricing==true
                    &&widget.problemModel.IsNeedRepricing==false) ||(
                    widget.problemModel.isOrderStartedFromMaintenance==false
                ) )
            )
              InkWell(
                child: Column(
                            ...
                            child: Center(
                              child: Row(
                                ...
                                children: [
                                  Icon(Icons.notifications_active_rounded,  color: Colors.yellowAccent,),
                                  Text(
                                    'wait owner choose visit pricing date',
                                    style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                    ),
                      ...
                      child:Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: nowToString==widget.problemModel.datePricing ? widget.onPress:(){},
                            child: Center(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(nowToString==widget.problemModel.datePricing?Icons.question_mark :
                                    Icons.notifications_active_rounded,
                                    color: Colors.yellowAccent,),
                                  if( nowToString!=widget.problemModel.datePricing)
                                  Text(
                                    'owner choosed visit pricing date',
                                    style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ...
                                  if( nowToString==widget.problemModel.datePricing)
                                    Text(
                                      'pricing date is today, start order ?',
                                      style: const TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.bold,
                                      ),
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(widget.problemModel.solvingDate==widget.problemModel.requiredDateFromCustomer?
                            "waiting customer agree to pay"
                                :
                              "wait customer agree to solving date",
                              style: const TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                              ),
...
String getorderStatus(ProblemModel p){
  ...
  if(p.solvingDate.length>3 &&p.isPaid==false
      ...
      &&p.waitingForCustomerToAgreeForSolvingDate==false
      &&p.isCustomerRespondedtoSolvingDate==true)
  {return "owner not agree to solve Date\n want solve date ${p.requiredDateFromCustomer}";}
